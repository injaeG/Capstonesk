...
//     version 1.3.0
//     from Assets/assets/InputSystem/LastUIInputActions.inputactions
//
...
public partial class @LastUIInputActions : IInputActionCollection2, IDisposable
{
    ...
    private ILastUIActions m_LastUIActionsCallbackInterface;
    ...
    public struct LastUIActions
    {
        ...
        {
            if (m_Wrapper.m_LastUIActionsCallbackInterface != null)
            {
                @Navigate.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnNavigate;
                @Navigate.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnNavigate;
                @Navigate.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnNavigate;
                @Submit.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnSubmit;
                @Submit.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnSubmit;
                @Submit.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnSubmit;
                @Cancel.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnCancel;
                @Cancel.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnCancel;
                @Cancel.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnCancel;
                @Point.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnPoint;
                @Point.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnPoint;
                @Point.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnPoint;
                @Click.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnClick;
                @Click.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnClick;
                @Click.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnClick;
                @ScrollWheel.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnScrollWheel;
                @ScrollWheel.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnScrollWheel;
                @ScrollWheel.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnScrollWheel;
                @MiddleClick.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnMiddleClick;
                @MiddleClick.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnMiddleClick;
                @MiddleClick.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnMiddleClick;
                @RightClick.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnRightClick;
                @RightClick.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnRightClick;
                @RightClick.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnRightClick;
                @TrackedDevicePosition.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDevicePosition;
                @TrackedDevicePosition.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDevicePosition;
                @TrackedDevicePosition.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDevicePosition;
                @TrackedDeviceOrientation.started -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDeviceOrientation;
                @TrackedDeviceOrientation.performed -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDeviceOrientation;
                @TrackedDeviceOrientation.canceled -= m_Wrapper.m_LastUIActionsCallbackInterface.OnTrackedDeviceOrientation;
            }
            m_Wrapper.m_LastUIActionsCallbackInterface = instance;
            if (instance != null)
            {

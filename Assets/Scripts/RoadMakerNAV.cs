...
public class RoadMakerNAV : MonoBehaviour
{
    ...
    public NavMeshSurface navMeshSurface; // NavMeshSurface component
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Car"))
        {
            ...
            UpdateNavMesh(); // Update NavMesh after spawning prefab
        }
    }
